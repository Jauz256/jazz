...
```bash
PHASE_INFO=$(node /Users/aungkyawmin/.claude/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /Users/aungkyawmin/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /Users/aungkyawmin/.claude/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}" --raw)
```
