...
```bash
TRANSITION=$(node /Users/aungkyawmin/.claude/get-shit-done/bin/gsd-tools.js phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /Users/aungkyawmin/.claude/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
